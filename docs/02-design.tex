...
\hline
near\_threshold & Ближний порог расстояния (км) & Вещественное число & Положительное, по умолчанию 3 \\
\hline
far\_threshold & Дальний порог расстояния (км) & Вещественное число & Положительное, по умолчанию 5 \\
\hline
...
\begin{figure}[H]
		\center{\includegraphics[scale=0.63]{img/function_2}}
